...
?>
												...
												<td><div class="btn-group">
													<?php echo anchor('admin/users/edit/'.$user->id, '<i class="fa fa-edit"></i> '.lang('actions_edit'), array('class' => 'btn btn-info btn-flat btn-sm')); ?>
													<?php echo anchor('admin/users/profile/'.$user->id, '<i class="fa fa-eye"></i> '.lang('actions_see').'</i>', array('class' => 'btn btn-info btn-flat btn-sm')); ?>
													</div>
												</td>
											</tr>
<?php endforeach;?>
